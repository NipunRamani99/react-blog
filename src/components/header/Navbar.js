...
function Navbar() {
    ...
    return (
      ...
      <BootstrapNavbar.Brand className="ms-auto me-auto my-2 brand-title" id="brand-title-name">
      NIPUN RAMANI</BootstrapNavbar.Brand>
       <Nav className="ms-auto me-auto"
                    style={{maxHeight:'100px'}}>
       <Nav.Link className="mleft-1" id="nav-link"  href="/about">about me</Nav.Link>
       <Nav.Link className="mleft-1" id="nav-link" href="/project">projects</Nav.Link>
